...
merged2_T4 <- merge(merged2, BES7, by = "id")
...
merged2_T4 <- merge(merged2, BES11, by = "id")
...
merged2_T4$redistchange <- merged2_T4$redistSelf11 - merged2_T4$redistSelf7
