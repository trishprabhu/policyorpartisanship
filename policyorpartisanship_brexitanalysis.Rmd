...
Once again, the results here suggest very small differences between the linear 
and logistic regression models, suggesting that the authors didn't necessarily
have something to gain in utilizing logistic regression. In particular,
across all of the coefficient estimates/odd ratios, as well as the probability
values, the direction of the coefficients are consistent. For the most part,
the significance of the values are consistent as well, with the singular
exception of the "Perceived Change in Conservative Euroskepticism" coefficient
losing one significance star in the logistic regression model (the coefficient/
probability value is still significant at the 0.05 level across both models,
however). With that said, once again, the value-add of the logistic regression
here is in the additional nuance/understanding of the results.
