...
this implies that the logistic regression model ultimately captures and reflects
more uncertainty, a key area of "value-add" in interpreting the results.
...
the "value-add" of the logistic regression is in this additional nuance in 
...
of the paper, it did add additional nuance/understanding to interpretation of 
