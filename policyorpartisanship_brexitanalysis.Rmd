...
What about non-Conservatives? In Table 6, the authors extend their analysis to
answer exactly that question. Here, I began by looking at individuals who did 
not report voting for the Conservative Party in 2015 (pre-referendum); I then 
created a "switchtocon" variable that indicated if a given unit ultimately 
...
associated with an increase in the likelihood of voting for the Conservative
Party in 2017  of 4.7%. Once again, this coefficient is significant at the 0.05
level.
