...
summary(intreg1a_logistic)

# Let's look at the null and residual deviance:
...
# Here, we calculate the odds ratio of the various coefficients; the odds
...
# Let's consider the most simple regression: 

# The odds ratio for female is 0.9672463; this suggests that a one-unit increase
# in pre-referendum Euroskepticism is associated with a decrease in the
# probability of defection from the Conservatives (as we would predict).
