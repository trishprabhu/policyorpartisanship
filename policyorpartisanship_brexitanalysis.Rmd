...
```
### As previously non-Conservative Euroskeptics flocked to the party, what happened to their views on other issues?
```{r}
...
# Run the regressions we'll include in Table 6 (below)!
