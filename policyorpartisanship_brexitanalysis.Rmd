...
in magnitude, suggesting additional nuance.

^Add to this last sentence that the difference in standard error means that
the logistic regression reflects more uncertainty.
...
at the 0.05 level across both models). With that said, once again, the 
"value-add" of the logistic regression here is in the additional nuance/
understanding of the results.

^Mention SE thing here as well; this is what is causing that loss of the
significance star!
