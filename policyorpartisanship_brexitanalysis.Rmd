...
The authors then turn to another interesting, related question: "As previously 
...
2019).
To answer this question, the authors select redistribution as the policy issue
they'll examine; they note that it remains a key political issue in the UK. I
begin by looking at Waves 7 and 11 (the pre and post-referendum surveys that ask
about redistribution). Like the authors, I create a new variable, "redistchange,"
...
regress this variable on our "switchtocons" variable (an indicator of whether
