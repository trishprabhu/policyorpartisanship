...
The results above suggest that in the case of Table 1, the authors ultimately 
didn't have a lot to gain in utilizing logistic regression instead of linear 
regression; neither the significance nor the direction of any of the 
coefficient estimates change. With that said, we do get a clearer, more nuanced 
picture of the results with an odds ratio interpretation; specifically, it more
concretely allows us to compare the relative magnitudes of the various 
...
Once again, the results here indicate little to no difference between the linear 
and logistic regression models, suggesting that the authors didn't necessarily
have much to gain in utilizing logistic regression. In particular, across all of 
...
captures and reflects additional uncertainty. Ultimately, then, like Table 1,
