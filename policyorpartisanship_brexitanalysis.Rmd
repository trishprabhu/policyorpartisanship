...
# logistic? What about the big differences in the probability values; anything
# to take away there?
...
The results above suggest that the authors ultimately didn't have a lot to gain
in utilizing logistic regression in lieu of linear regression; neither the
significance nor the direction of the coefficients change. With that said,
we do get a clearer, more nuanced picture of the results with an odds ratio
interpretation, which more concretely allows us to understand the relative
magnitudes of the various coefficients. *What about the probability values?
Le: Once again, direction/sign/significance stays the same, but we get a more
nuanced picture, given the variance in magnitude.
