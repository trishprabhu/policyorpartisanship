...
The authors also explore various related questions, such as whether newly minted
Conservative voters also updated their stances on other policy issues to bring
them further into line with the Conservative party; looking specifically at the
issue of redistribution, they find that this is indeed the case. The authors
also look at whether.. The authors' other results/conclusions are discussed
in detail in the next section.

In this report, I replicate the authors' main results (6 tables and 2 figures),
providing my analyses/interpretation, and then, consider ways to extend the
authors' work, in this case, by employing another regression method particularly
suited to analyses with binary outcomes (such as switching) -- logistic 
regression.
