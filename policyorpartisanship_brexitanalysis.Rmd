...
The results here indicate notable differences between the linear and logistic
regression models, suggesting that the authors did indeed have something to
gain (e.g. in the way of insights/findings) in utilizing logistic regression.
Looking at the first set of graphs, which plot the model estimates and odds
ratios, respectively, we can see that the significance of 

Discuss significance/direction changes; keep in mind if initial value was
significant, as this can explain direction changes.
