...
Note for Trisha: Footnotes are put inside the square brackets after a caret ^[], e.g., ^[This is a footnote.]
...
figures), providing my analyses/interpretation. Then, in the third section, I
...
switching parties) -- logistic regression.
...
# Question for Le: How do I get this above the start of the "Proposed Extension"
# section?
# https://stackoverflow.com/questions/55317759/how-to-keep-a-table-here-defnitely-in-r-markdown
