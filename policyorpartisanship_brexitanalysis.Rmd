...
# Plot them side by side; explore "cowplot" package
...
regression; neither the significance nor the direction of the coefficients 
change. With that said, we do get a clearer, more nuanced picture of the results 
with an odds ratio interpretation, which more concretely allows us to understand 
relative magnitudes of the various coefficients. The same is true in the case
of the probability values: while, across both linear and logistic, the 
direction/significance of coefficients stay the same, we do see the magnitude
of the probabilities vary a bit more with the logistic regression, suggesting
additional nuance.
