...
across both linear and logistic, the direction/significance of probabilities 
stay the same, we do see the logistic probability estimates vary a bit more
...
the coefficient estimates/odd ratios, as well as the probability values, the 
direction of the values are consistent. For the most part, the significance of 
the values are consistent as well, with the singular exception of the 
"Perceived Change in Conservative Euroskepticism" coefficient losing one 
significance star in the logistic regression model (the coefficient/probability 
value is still significant at the 0.05 level across both models, however). With 
that said, once again, the "value-add" of the logistic regression here is in the 
additional nuance/understanding of the results.

# IV. Conclusion

End with some takeaways: based on my analysis, what should be done?
