...
This replication began with one key question: what drives voters -- policy, or
partisanship? In replicating the results of "Policy or Partisanship in the 
United Kingdom? Quasi-Experimental Evidence from Brexit," I was able to exploit
the UK's Brexit referendum to demonstrate that, in fact, policy seems to be
critical.
...
that future work aim to address these limitations.
