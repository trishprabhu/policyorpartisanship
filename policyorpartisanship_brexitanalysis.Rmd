...
2019).
Like the authors, I began by looking at defection from the Conservative Party.
I first created a "voteswitcher" variable, which indicated if a given unit that 
voted for the Conservatives in 2015 (pre-referendum), ultimately defected/voted 
for another party in 2017. I then regressed voteswitcher on the voter's level of 
Euroskepticism in 2015; in 2 other regressions, I added perceived changes in the
Euroskepticism of the Conservative Party as an interaction, as well as threw in 
a bunch of relevant covariates.
