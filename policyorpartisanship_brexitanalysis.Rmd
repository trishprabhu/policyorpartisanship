...
obtained here: . The original data/code is cited in the "References" section
below.] the authors' main results (6 tables and 2 figures), providing my analyses/
interpretation (which confirm the authors' conclusions). Like the authors, I 
used linear regression models to produce these results. Then, in the third 
section, I consider ways to extend the authors' work, in this case, by employing 
another regression method particularly suited to analyses with binary outcomes 
(such as switching parties) -- logistic regression. As discussed in that section, 
the implications of such work are a more nuanced picture (e.g. a better 
understanding of uncertainty, etc.) of the results.
