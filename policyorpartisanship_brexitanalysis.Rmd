...
interpretation. Then, in the third section, I consider ways to extend the 
...
model binary outcomes" (Gelman and Hill 2007); nevertheless, the authors
never employ it in the paper. What if, I wondered, I performed the regressions 
summarized in Table 1 and 2 via logistic regression? Would the results change; 
otherwise, would we see any interesting findings?
